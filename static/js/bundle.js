...
var app = (function (exports) {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			h1 = element("h1");
    			h1.textContent = "O Hai.";
    			t1 = space();
    			button = element("button");
    			button.textContent = "Click me!";
    			add_location(h1, file, 50, 2, 1315);
    			attr_dev(button, "class", "buttons svelte-1g3bhbg");
    			add_location(button, file, 51, 2, 1333);
    			add_location(div, file, 49, 0, 1307);
    		},
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(button, "click", /*fetchServerOptions*/ ctx[0], false, false, false, false);
    				mounted = true;
    			}
    		},
    		p: noop,
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	const fetchServerOptions = async () => {
    		console.log('Attempting to fetch /auth/webauthn/generate');
    		const res = await fetch('https://cyberpunk.nyc/auth/webauthn/generate');
    		...
    		try {
    			...
    			if (error.name === 'InvalidStateError') {
    				...
    				console.log(`startRegistration Error: ${error.message}`);
    			}
    		...
    		const verificationResp = await fetch('https://cyberpunk.nyc/auth/webauthn/verify', {
    			method: 'POST',
